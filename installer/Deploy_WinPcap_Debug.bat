...
xcopy /Y	"..\packetWin7\npf\Win7Debug\%DRIVER_NAME%\%DRIVER_NAME%.cat"						.\%DEPLOY_FOLDER_NAME%\x86
xcopy /Y	"..\packetWin7\npf\Win7Debug\%DRIVER_NAME% Package\%DRIVER_NAME%.inf"						.\%DEPLOY_FOLDER_NAME%\x86
xcopy /Y	"..\packetWin7\npf\Win7Debug\%DRIVER_NAME% Package\%DRIVER_NAME%_wfp.inf"					.\%DEPLOY_FOLDER_NAME%\x86
xcopy /Y	"..\packetWin7\npf\Win7Debug\%DRIVER_NAME% Package\%DRIVER_NAME%.sys"						.\%DEPLOY_FOLDER_NAME%\x86
xcopy /Y	"..\packetWin7\npf\x64\Win7Debug\%DRIVER_NAME%\%DRIVER_NAME%.cat"					.\%DEPLOY_FOLDER_NAME%\x64
xcopy /Y	"..\packetWin7\npf\x64\Win7Debug\%DRIVER_NAME% Package\%DRIVER_NAME%.inf"					.\%DEPLOY_FOLDER_NAME%\x64
xcopy /Y	"..\packetWin7\npf\x64\Win7Debug\%DRIVER_NAME% Package\%DRIVER_NAME%_wfp.inf"				.\%DEPLOY_FOLDER_NAME%\x64
xcopy /Y	"..\packetWin7\npf\x64\Win7Debug\%DRIVER_NAME% Package\%DRIVER_NAME%.sys"					.\%DEPLOY_FOLDER_NAME%\x64

xcopy /Y	"..\packetWin7\npf\VistaDebug\%DRIVER_NAME%\%DRIVER_NAME%.cat"						.\%VISTA_DEPLOY_FOLDER_NAME%\x86
xcopy /Y	"..\packetWin7\npf\VistaDebug\%DRIVER_NAME% Package\%DRIVER_NAME%.inf"						.\%VISTA_DEPLOY_FOLDER_NAME%\x86
xcopy /Y	"..\packetWin7\npf\VistaDebug\%DRIVER_NAME% Package\%DRIVER_NAME%_wfp.inf"					.\%VISTA_DEPLOY_FOLDER_NAME%\x86
xcopy /Y	"..\packetWin7\npf\VistaDebug\%DRIVER_NAME% Package\%DRIVER_NAME%.sys"						.\%VISTA_DEPLOY_FOLDER_NAME%\x86
xcopy /Y	"..\packetWin7\npf\x64\VistaDebug\%DRIVER_NAME%\%DRIVER_NAME%.cat"					.\%VISTA_DEPLOY_FOLDER_NAME%\x64
xcopy /Y	"..\packetWin7\npf\x64\VistaDebug\%DRIVER_NAME% Package\%DRIVER_NAME%.inf"					.\%VISTA_DEPLOY_FOLDER_NAME%\x64
xcopy /Y	"..\packetWin7\npf\x64\VistaDebug\%DRIVER_NAME% Package\%DRIVER_NAME%_wfp.inf"				.\%VISTA_DEPLOY_FOLDER_NAME%\x64
xcopy /Y	"..\packetWin7\npf\x64\VistaDebug\%DRIVER_NAME% Package\%DRIVER_NAME%.sys"					.\%VISTA_DEPLOY_FOLDER_NAME%\x64
